...
export const metadata: Metadata = {
  ...
  description: "The page you are looking for may have been moved or no longer exists. Browse available properties at The Oasis by Emaar.",
  robots: {
    index: false,
    follow: false,
  },
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-[#0D1B2A]">
      <div className="max-w-2xl mx-auto px-4 text-center">
        ...
        {/* Description */}
        <p className="font-body text-gray-400 max-w-lg mx-auto mb-8 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          <Link href="/projects">
            <Button size="lg" variant="outline" className="border-[#C8A45C] text-[#C8A45C] font-bold px-8 py-6 rounded-md hover:bg-[#C8A45C]/10 hover:text-[#C8A45C] w-full sm:w-auto">
        ...
        <div className="bg-white/5 rounded-xl p-6 sm:p-8 border border-white/10">
          <h2 className="font-heading text-lg font-bold text-[#C8A45C] mb-4">
            Popular Pages
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="font-body text-sm text-white/60 hover:text-[#C8A45C] transition-colors py-2 px-3 rounded-md hover:bg-white/5"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            ...
            <div className="flex items-center justify-center gap-4">
              <a
                ...
                className="flex items-center gap-2 text-sm font-semibold text-white/70 hover:text-[#C8A45C] transition-colors"
              >
              ...
              <a
                ...
                className="text-sm font-semibold text-white/70 hover:text-[#C8A45C] transition-colors"
              >
