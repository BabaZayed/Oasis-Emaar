...
export const metadata: Metadata = {
  ...
  description:
    "استكشف واحة إعمار مع وكيل مبيعات معتمد. مجتمع واجهة بحرية فاخر في دبي يضم فلل فاخرة وقصوراً ووحدات سكنية علامة تجارية. تبدأ الأسعار من 9.2 مليون درهم. إرشاد متخصص ووصول حصري للمخزون.",
  keywords: [
    "فلل دبي",
    "واحة إعمار",
    "عقارات دبي",
  ...
  openGraph: {
    title: "واحة إعمار | وكيل معتمد — فلل فاخرة على الواجهة البحرية في دبي",
    description:
      "استكشف واحة إعمار مع وكيل مبيعات معتمد. مجتمع واجهة بحرية فاخر في دبي يضم فلل فاخرة وقصوراً. تبدأ الأسعار من 9.2 مليون درهم.",
    url: "https://www.oasisemaar.com/ar",
  ...
  twitter: {
    ...
    title: "واحة إعمار | وكيل معتمد — فلل فاخرة على الواجهة البحرية في دبي",
    description: "استكشف واحة إعمار مع وكيل مبيعات معتمد. فلل فاخرة وقصور تبدأ من 9.2 مليون درهم.",
    images: ["/og-image.jpg"],
    creator: "@OasisEmaar",
    site: "@OasisEmaar",
  },
  alternates: {
    canonical: "https://www.oasisemaar.com/ar",
    languages: {
...
const realEstateAgentJsonLd = {
  ...
  description:
    "وكيل مبيعات معتمد لواحة إعمار في دبي. نقدم فلل واجهة بحرية فاخرة وقصوراً ووحدات سكنية علامة تجارية تبدأ من 9.2 مليون درهم.",
  url: "https://www.oasisemaar.com/ar",
  ...
  priceRange: "9.2 مليون درهم - 50 مليون+ درهم",
  areaServed: {
    "@type": "City",
    name: "دبي",
  },
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "تبدأ أسعار الفلل في واحة إعمار من 9.2 مليون درهم لفلل بالميرا 3 ذات الأربع غرف نوم، وتصل إلى أكثر من 50 مليون درهم لقصور لافيتا الفائقة الفخامة. يتراوح نطاق الأسعار عبر جميع المجموعات التسع من 9.2 مليون إلى أكثر من 50 مليون درهم.",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.oasisemaar.com/ar",
    },
  ],
};
