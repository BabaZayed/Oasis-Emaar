...
const clusters = [
  ...
  { name: "بالميرا 3", price: "9.2 مليون درهم", beds: "4 غرف نوم", slug: "palmiera-3" },
  ...
  { name: "بالميرا الجماعية", price: "11 مليون درهم", beds: "4 غرف نوم", slug: "palmiera-collective" },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "تبدأ أسعار الفلل في واحة إعمار من 9.2 مليون درهم لفلل بالميرا 3 ذات الأربع غرف نوم، وتصل إلى أكثر من 50 مليون درهم لقصور لافيتا الفائقة الفخامة.",
  },
  {
      ...
      <div dir="rtl" lang="ar" className="min-h-screen flex flex-col">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              {[
                { icon: Home, label: "تبدأ الأسعار من", value: "9.2 مليون درهم" },
