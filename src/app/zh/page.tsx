...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.oasisemaar.com/zh",
    siteName: "伊玛尔绿洲 — 授权代理",
    type: "website",
    locale: "zh_CN",
    images: [
  ...
  alternates: {
    canonical: "https://www.oasisemaar.com/zh",
    languages: {
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "交房时间因社区而异：Palmiera 3预计最早完工（2028年第四季度），其次是Palmiera、Lavita和Palmiera Collective（2029年第一至二季度）。Address Villas Tierra预计2029年6月，Palace Villas Ostra预计2029年9月，Mirage预计2029年第四季度。",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "伊玛尔绿洲 — 中文",
      item: "https://www.oasisemaar.com/zh",
    },
  ],
};
