...
const clusters = [
  ...
  { name: "Palmiera Collective", price: "1,100万迪拉姆", beds: "4卧室", slug: "palmiera-collective" },
];
...
const faqs = [
  ...
  {
    q: "伊玛尔绿洲何时完工？",
    a: "交房时间因社区而异：Palmiera 3预计最早完工（2028年第四季度），其次是Palmiera、Lavita和Palmiera Collective（2029年第一至二季度）。Address Villas Tierra预计2029年6月，Palace Villas Ostra预计2029年9月，Mirage预计2029年第四季度。",
  },
  {
    q: "我是否符合黄金签证条件？",
