...
const clusters = [
  ...
  { name: "Palmiera 3", beds: "4 Ch.", price: "dès 9,2M AED", tag: "Villas" },
  ...
  { name: "Palmiera Collective", beds: "4 Ch.", price: "dès 10,75M AED", tag: "Édition Limitée" },
];
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#1A2332]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-24">
          ...
          >
            {[
              { icon: Home, value: "dès 9,2M AED", label: "Prix de Départ" },
