...
export const metadata: Metadata = {
  ...
  description:
    "Исследуйте Оазис Эмаар с авторизованным агентом по продажам. Премиальный прибрежный комплекс в Дубае с роскошными виллами, особняками и брендовыми резиденциями. Цены от 9.2 млн дирхам. Экспертное руководство, эксклюзивный доступ к объектам.",
  keywords: [
    "виллы дубай",
    "оазис эмаар",
    "недвижимость дубай",
  ...
  openGraph: {
    title: "Оазис Эмаар | Авторизованный агент — Роскошные виллы у воды в Дубае",
    description:
      "Исследуйте Оазис Эмаар с авторизованным агентом. Премиальный прибрежный комплекс в Дубае с роскошными виллами и особняками. Цены от 9.2 млн дирхам.",
    url: "https://www.oasisemaar.com/ru",
  ...
  twitter: {
    ...
    title: "Оазис Эмаар | Авторизованный агент — Роскошные виллы у воды в Дубае",
    description: "Исследуйте Оазис Эмаар. Премиальный прибрежный комплекс, цены от 9.2 млн дирхам.",
    images: ["/og-image.jpg"],
    creator: "@OasisEmaar",
    site: "@OasisEmaar",
  },
  alternates: {
    canonical: "https://www.oasisemaar.com/ru",
    languages: {
      "en": "https://www.oasisemaar.com",
      "ar": "https://www.oasisemaar.com/ar",
      "zh": "https://www.oasisemaar.com/zh",
      "ru": "https://www.oasisemaar.com/ru",
      "fr": "https://www.oasisemaar.com/fr",
      "de": "https://www.oasisemaar.com/de",
    },
  },
};
...
const realEstateAgentJsonLd = {
  ...
  description:
    "Авторизованный агент по продажам Оазиса Эмаар в Дубае. Предлагаем роскошные прибрежные виллы, особняки и брендовые резиденции от 9.2 млн дирхам.",
  url: "https://www.oasisemaar.com/ru",
  ...
  priceRange: "9.2 млн - 50 млн+ дирхам",
  areaServed: {
    "@type": "City",
    name: "Дубай",
  },
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Цены на виллы в Оазисе Эмаар начинаются от 9.2 млн дирхам за четырёхкомнатные виллы Palmiera 3 и достигают более 50 млн дирхам за ультрароскошные особняки Lavita. Диапазон цен по всем девяти кластерам — от 9.2 до 50+ млн дирхам.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Сроки передачи зависят от кластера: Palmiera 3 ожидается первым (Q4 2028), за ним следуют Palmiera, Lavita и Palmiera Collective (Q1-Q2 2029). Address Villas Tierra — июнь 2029, Palace Villas Ostra — сентябрь 2029, Mirage — Q4 2029.",
      },
    },
    {
      "@type": "Question",
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: "Главная",
      item: "https://www.oasisemaar.com",
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Оазис Эмаар — Русский",
      item: "https://www.oasisemaar.com/ru",
    },
  ],
};
...
const webPageJsonLd = {
  ...
  publisher: {
    ...
    logo: {
      "@type": "ImageObject",
      url: "https://www.oasisemaar.com/logo.svg",
    },
  },
};
