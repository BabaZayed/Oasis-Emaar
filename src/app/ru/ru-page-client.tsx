...
const clusters = [
  ...
  { name: "Palmiera 3", price: "9.2 млн дирхам", beds: "4 спальни", slug: "palmiera-3" },
  ...
  { name: "Address Villas Tierra", price: "13.16 млн дирхам", beds: "4-6 спален", slug: "address-villas-tierra" },
  { name: "Palace Villas Ostra", price: "13.9 млн дирхам", beds: "4-6 спален", slug: "palace-villas-ostra" },
  { name: "Palmiera Collective", price: "11 млн дирхам", beds: "4 спальни", slug: "palmiera-collective" },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Цены на виллы начинаются от 9.2 млн дирхам за четырёхкомнатные виллы Palmiera 3 и достигают более 50 млн дирхам за ультрароскошные особняки Lavita. Девять кластеров охватывают различные ценовые категории для любых инвестиционных целей.",
  },
  {
  ...
  },
  {
    ...
    a: "Сроки передачи зависят от кластера: Palmiera 3 ожидается первым (Q4 2028), за ним следуют Palmiera, Lavita и Palmiera Collective (Q1-Q2 2029). Address Villas Tierra — июнь 2029, Palace Villas Ostra — сентябрь 2029, Mirage — Q4 2029.",
  },
  {
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Address Villas Tierra · Lavita · Mareva · Mirage · Palace Villas Ostra · Palmiera Collective · Palmiera
            <br />
          ...
          >
            {[
              { icon: Home, label: "Цены от", value: "9.2 млн AED" },
