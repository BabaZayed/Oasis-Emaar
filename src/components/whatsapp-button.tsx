  ...
  return (
    <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-50 flex items-end gap-3">
      ...
      <AnimatePresence>
        {showTooltip && !dismissed && (
          ...
          >
            ...
            <p className="text-[#1A2332] text-sm font-semibold mb-1">Need help?</p>
            <p className="text-gray-500 text-xs leading-relaxed">Chat with our property expert on WhatsApp for instant assistance.</p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.a
        ...
        onClick={() => trackLead({ formType: "general", propertyInterest: "WhatsApp Inquiry" })}
