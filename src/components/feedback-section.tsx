...
const existingFeedback: FeedbackItem[] = [
  {
    ...
    comment: "The lagoon views are absolutely stunning. We visited the site last month and were blown away by the scale of the project. Emaar's quality is evident in every detail.",
    date: "2 weeks ago",
    verified: false,
  },
  {
    ...
    rating: 5,
    property: "Palmiera 3",
    comment: "I purchased a villa as an investment. The location is fantastic — close to everything yet feels like a private resort. The payment plan made it very accessible.",
    date: "1 month ago",
    verified: false,
  },
  {
    ...
    rating: 4,
    property: "Mareva",
    comment: "Great community design and the lagoon-side concept is unique in Dubai. The villa layouts are practical for families.",
    date: "3 weeks ago",
    verified: false,
  },
  {
    ...
    comment: "The mansion designs are extraordinary — private elevators, wine cellars, infinity pools. This is truly next-level luxury from Emaar.",
    date: "1 week ago",
    verified: false,
  },
];
